...
> **模块说明**: 本板块按人群层级（TA）× Ads format 拆分，统计各人群层级的投放花费、成交、点击、加购等指标，并衍生占比与效率指标。
...
| 规则项 | 说明 |
|---|---|
| **数据底表** | 全部指标统一使用 `a05_e2e_paid_media_crowed_data_d` |
| **行维度** | 人群层级（TA）× Ads format |
| **渠道筛选** | 统一为 `channel=引力魔方/直通车/全站推` |
