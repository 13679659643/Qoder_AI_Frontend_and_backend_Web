-- ════════════════════════════════════════════════════════════════════
-- Slicer_Time_Frame_With_LY 维度表（含 LY 字段）
...
-- 原始文件：Slicer_Time_Frame.sql（未修改）
-- ════════════════════════════════════════════════════════════════════
...
LEFT JOIN base b
    ...
    AND (
        ...
        (a.TimeFrame_ID = 'Day'   AND b.TimeFrame_Min = addMonths(a.TimeFrame_Min, -12))
...
4. 本文件为 Slicer_Time_Frame.sql 的增强版本，原始文件未修改，保留作为对照。
