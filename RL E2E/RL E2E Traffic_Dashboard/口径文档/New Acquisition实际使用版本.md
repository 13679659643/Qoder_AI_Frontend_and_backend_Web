...
| **TM和JD的channel映射关系**| 直通车 -- 快车  引力魔方 -->触点  全站推-->海投，也就是在 `a05_e2e_paid_media_summary_d`表中TM平台的直通车渠道，在JD平台中表示为快车,DY和RLE的暂时不管。|
...
### 7. Cost 引力魔方 触点占比 — 引力魔方 触点 花费（引力魔方/触点 + 直通车/快车）a05_e2e_paid_media_crowed_data_d表的值计算。
...
### 11. Cost 直通车 快车占比 — 直通车 快车 花费（引力魔方/触点 + 直通车/快车）a05_e2e_paid_media_keyword_data_d表来计算。
